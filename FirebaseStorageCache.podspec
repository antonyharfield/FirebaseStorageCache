#
#  Be sure to run `pod spec lint FirebaseStorageCache.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
    Is your Firebase Storage code hitting the network too often? Would you like Firebase
  ...
  s.homepage     = "https://github.com/antonyharfield/FirebaseStorageCache"
  ...
  # Or just: s.author    = "Antony Harfield"
  # s.authors            = { "Antony Harfield" => "antonyharfield@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Antony Harfield"
  ...
  s.source       = { :git => "https://github.com/antonyharfield/FirebaseStorageCache.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "FirebaseStorageCache"
